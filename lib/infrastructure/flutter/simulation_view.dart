...
const String kBuildStamp = 'build 0.3.3.276-plat2d';
...
class _SimulationViewState extends State<SimulationView> with SingleTickerProviderStateMixin {
  ...
  Vec2? _heatAt;
  /// The colony site's ground radius, cached against the colony, its site
  /// and its terrain edit count (see `_colonySiteRadius`).
